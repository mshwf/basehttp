...
{
    internal class BaseHttpService5SecTimeout : IBaseHttpService
    {
        static BaseHttpService5SecTimeout()
        {
            if (_client == null)
            {
        ...
        public BaseHttpService5SecTimeout(string serviceName, bool acceptOnlyOkResponse, HttpClientOptions httpClientOptions)
        {
