...
{
    internal class BaseHttpService : IBaseHttpService
    {
        static BaseHttpService()
        {
            if (_client == null)
            {
        ...
        public BaseHttpService(string serviceName, bool acceptOnlyOkResponse, HttpClientOptions httpClientOptions)
        {
